...
router.post("/", (0, setup_1.authMiddleware)(["PRINCIPAL"]), eventController_1.createEvent);
// Update event (principals only)
router.put("/:id", (0, setup_1.authMiddleware)(["PRINCIPAL"]), eventController_1.updateEvent);
// Delete event (principals only)
router.delete("/:id", (0, setup_1.authMiddleware)(["PRINCIPAL"]), eventController_1.deleteEvent);
// Upload event images
router.post("/:id/images", (0, setup_1.authMiddleware)(["PRINCIPAL"]), upload.array("images", 10), eventController_1.uploadEventImages);
// RSVP to event
